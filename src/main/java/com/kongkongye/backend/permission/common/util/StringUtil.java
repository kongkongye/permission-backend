...
public class StringUtil {
    ...
    public static String fix(String str, int maxLength) {
        if (str == null) {
            return str;
        }
...
//        return generateStr(StringConsts.CHARS, length);
//    }
//
//    /**
...
//        return generateStr(StringConsts.CHARS_SEE, length);
//    }
//
//    /**
//     * 随机生成小写字符串(不包含容易产生视觉混淆的字符如i与1)
//     * @param length 长度,>=1
//     */
//    public static String generateStrSeeLower(int length) {
//        return generateStr(StringConsts.CHARS_SEE_LOWER, length);
//    }
    ...
    public static String generateStr(String chars, int length) {
        ...
        for (int count = 0; count < length; count++) {
            sb.append(chars.charAt(r.nextInt(size)));
        }
        return sb.toString();
    }
